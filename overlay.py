...
object_to_detect = 'flower'  # replace with desired object

# load an image from a relative path
image_path = "image/flower.jpg"  # replace with image path
...
COCO_INSTANCE_CATEGORY_NAMES = [
    ...
    'vase', 'scissors', 'teddy bear', 'hair drier', 'toothbrush','flower'
]
...
if len(filtered_masks) > 0:
    img_with_effect = apply_bsod_overlay(img_cv, filtered_masks, overlay_image, alpha=0.8) # alpha=1 for no transparency
